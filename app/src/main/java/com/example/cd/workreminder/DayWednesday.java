...
public class DayWednesday extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dayOfTheWeek.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.e(PRODUCTION_TAG, "WEDNESDAY DAY POSITION IS: " + position);
                //dayPosition = position;
                switch (position) {
                    case 0:
                        intent.putExtra("CURRENT_DAY", WorkReaderContract.WorkEntry.WEDNESDAY);
